...
public class LoginGUI extends JFrame {
	...
	private void setupLayout() {
		...
		JTextArea infoArea = new JTextArea("💡 Como usar:\n" + "1. Conecte-se ao servidor\n"
	...
	private void conectarServidor() {
		try {
			...
			if (client.connect()) {
				...
				JOptionPane.showMessageDialog(this, "Erro ao conectar ao servidor!", "Erro de Conexão",
	...
	private void realizarLogin() {
		...
		if (result.isSuccess()) {
			...
			JOptionPane.showMessageDialog(this, result.getMessage(), "Erro de Login", JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	private void abrirCadastro() {
		if (client == null) {
			JOptionPane.showMessageDialog(this, "Conecte-se ao servidor antes de cadastrar usuários.", "Erro",
					JOptionPane.ERROR_MESSAGE);
			return;
		}
